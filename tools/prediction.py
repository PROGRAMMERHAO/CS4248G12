...
state_dict = safe_load_file('../models/fine_tuned_albert_model/model.safetensors')
...
with open('../eval/albert_fined_tuned_predictions.json', 'w') as f:
    json.dump(predictions, f)

print('Predictions saved to albert_fined_tuned_predictions.json')
