...
best_model_directory = '../models/fine_tuned_albert_xlarge_nomix_time_model'
...
final_save_directory = '../models/fine_tuned_albert_xlarge_nomix_model'
...
with open('../eval/fine_tuned_albert_predictions.json', 'w') as f:
    json.dump(predictions, f)

print('Predictions saved to fine_tuned_albert_predictions.json')
