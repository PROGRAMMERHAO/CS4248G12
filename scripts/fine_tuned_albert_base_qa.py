...
train_data = read_squad('../data/train-v2.0.json')
...
best_model_directory = '../models/fine_tuned_albert_base_model'
...
final_save_directory = '../models/fine_tuned_albert_base_model'
...
with open('../eval/fine_tuned_albert_base_predictions.json', 'w') as f:
    json.dump(predictions, f)

print('Predictions saved to fine_tuned_albert_base_predictions.json')
