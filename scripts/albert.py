...
best_model_directory = '../models/fine_tuned_albert_xlarge_rly_mix_time_model'
...
final_save_directory = '../models/fine_tuned_albert_xlarge_rly_mix_model'
...
with open('../eval/fine_tuned_albert_xlarge_mix_predictions.json', 'w') as f:
    json.dump(predictions, f)

print('Predictions saved to fine_tuned_albert_xlarge_predictions.json')
